                    ...
                    <div class="card-body">
                        <div class="presencecontent">
                            ...
                            <div class="presencedetail">
                                ...
                                <span>{{ $presensihariini != null ? $presensihariini->jam_in : 'Belum Foto' }}</span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <div class="presencecontent">
                            ...
                            <div class="presencedetail">
                                ...
                                <span>{{ $presensihariini != null && $presensihariini->jam_out != null ? $presensihariini->jam_out : 'Belum Foto' }}</span>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <li>
                            <div class="item">
                                ...
                                <div class="in">
                                    ...
                                    <span class="badge badge-danger">{{ $presensihariini != null && $d->jam_out != null ? $d->jam_out : "Belum Foto" }}</span>
                                </div>
                            </div>
                        </li>
                    @endforeach

    ...
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="text" readonly value="{{ $karyawan->nik }}" class="form-control" id="nik" name="nik" placeholder="NIP/NRP">
            </div>
        </div>
    </div>
    <div class="row">
    ...
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="text" value="{{ $karyawan->no_hp }}" class="form-control" id="no_hp" name="no_hp" placeholder="Nomor HP">
            </div>
        </div>
    </div>
    <div class="row">
